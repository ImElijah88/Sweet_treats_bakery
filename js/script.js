...
window.onload = function() {
    ...
    var navItems = '';
    if (isAdmin) {
        navItems = '<ul><li><a href="admin_dashboard.php">Dashboard</a></li><li><a href="manage_menu.php">Manage Menu</a></li><li><a href="view_feedback.php">Manage Feedback</a></li><li><a href="logout.php">Logout</a></li></ul>';
    } else if (isLoggedIn) {
        navItems = '<ul><li><a href="home.php">Home</a></li><li><a href="menu.php">Our Menu</a></li><li><a href="feedback.php">Reviews</a></li><li><a href="my_profile.php">My Profile</a></li><li><a href="feedback_form.php">Leave Review</a></li><li><a href="logout.php">Logout</a></li></ul>';
    } else {
        navItems = '<ul><li><a href="home.php">Home</a></li><li><a href="menu.php">Our Menu</a></li><li><a href="feedback.php">Reviews</a></li><li><a href="index.php">Login</a></li><li><a href="register.php">Register</a></li></ul>';
    }
